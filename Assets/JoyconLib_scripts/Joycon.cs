...
public class Joycon
{
    ...
    public Vector3 GetAccel1()
    {
        return new Vector3(j_b.x, i_b.x, k_b.x);
    }

    public Vector3 GetAccel2()
    {
        return new Vector3(j_b.y, i_b.y, k_b.y);
    }

    public Vector3 GetAccel3()
    {
        return new Vector3(j_b.z, i_b.z, k_b.z);
    }
